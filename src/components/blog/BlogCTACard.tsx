...
// Badge da Google Play — estilo ficha premium
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1.15 }}>
        <span style={{ fontSize: '8px', color: 'rgba(255,255,255,0.5)', textTransform: 'uppercase', fontWeight: 600, letterSpacing: '0.5px' }}>Android</span>
...
// Badge da App Store — estilo ficha premium
function AppStoreBadge() {
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1.15 }}>
        <span style={{ fontSize: '8px', color: 'rgba(255,255,255,0.5)', textTransform: 'uppercase', fontWeight: 600, letterSpacing: '0.5px' }}>iOS</span>
...
export function BlogCTACard() {
  ...
  return (
    <div style={{
      ...
      {/* Badges de lojas — estilo ficha premium */}
      <div style={{
        display: 'flex',
        gap: '10px',
        alignItems: 'center',
        ...
        {/* No mobile, destaca apenas o badge da plataforma atual */}
        {(platform === 'desktop' || platform === 'android') && <GooglePlayBadge />}
        {(platform === 'desktop' || platform === 'ios') && <AppStoreBadge />}
        {/* No mobile, exibe o badge da outra plataforma também, mas menor */}
        {platform === 'android' && (
          <div style={{ opacity: 0.6, transform: 'scale(0.9)', transformOrigin: 'left center' }}>
            <AppStoreBadge />
          </div>
        )}
        {platform === 'ios' && (
